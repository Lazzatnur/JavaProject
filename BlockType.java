...
public class BlockType {
	...
	public int[][][] blockBuilder(BlockSequence type) throws FileNotFoundException {
	...
	public BlockSequence getType() {
		return type;
	}

	public void setType(BlockSequence type) {
		this.type = type;
	}
